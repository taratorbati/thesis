...
#
# v2.1 fix: use_smooth is now passed through to compute_cost so that the
# drought deficit term also uses smooth_max_zero, ensuring the entire NLP
# (dynamics + cost) is C2-smooth when use_smooth=True.
# =============================================================================
