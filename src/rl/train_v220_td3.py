# src/rl/train_v220_td3.py  v2.20.0  (Stage 1)
# -----------------------------------------------------------------------------
# TD3 trainer for the Stage-1 stabilisation runs.  Place in src/rl/ alongside
...
from src.rl.configs_v220 import CONFIGS, GAMMA_BASE
...
def train_td3_v220(
    ...
    run_name = f"td3_v220_{cfg['label']}_seed{seed}"
    ...
    print(f"\n{'='*72}")
    print(f"  TD3 training - v2.20 Stage 1 - config {config_name} ({cfg['label']}) - seed {seed}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Train TD3 v2.20 Stage 1: v2.19b architecture + EXACT n-step (gamma^n "
